	...
	<tbody>
		...
		<tr>
			...
			<td>
				...
				<a id="btn_eliminar" href="#" onclick="event.preventDefault(); document.getElementById('delete-form-{{ $countrie->id }}').submit();" class="red waves-effect waves-light btn" style="margin-left: 0.5em"><i class="material-icons left">delete</i>Eliminar</a>
